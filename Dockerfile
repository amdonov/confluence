...
RUN curl -k -o confluence.bin https://downloads.atlassian.com/software/confluence/downloads/atlassian-confluence-5.8.16-x64.bin && chmod 755 confluence.bin && ./confluence.bin -q -varfile /root/response.varfile && rm confluence.bin && pkill java
