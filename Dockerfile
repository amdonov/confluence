...
RUN chmod -R 777 /opt/atlassian/confluence/logs /opt/atlassian/confluence/work /opt/atlassian/confluence/temp /opt/atlassian/confluence/conf /var/atlassian/application-data/confluence && echo "" > /opt/atlassian/confluence/bin/user.sh
